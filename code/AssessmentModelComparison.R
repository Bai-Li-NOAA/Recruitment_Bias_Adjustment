...
maindir <- "C:/Users/bai.li/Documents/Github/Age_Structured_Stock_Assessment_Model_Comparison/example/ricker_bias_adjustment"
...
#### Case 2_AC (SS bias adjustment=FALSE and convert h for inputs) ####
updated_input <- save_initial_input(base_case=FALSE,
                                    input_list=base_case_input,
                                    case_name="C2_AC",
                                    om_bias_cor=TRUE,
                                    ...
                                    em_bias_cor=TRUE)
run_om(input_list=updated_input , show_iter_num=F)
run_em(em_names=c("SS"), input_list=updated_input)
updated_input$keep_sim_num=90
generate_plot(em_names = c("AMAK", "BAM", "SS"),
              plot_ncol=3, plot_nrow=1,
              plot_color = c("orange", "red", "deepskyblue3"),
...
#### Case 4 (EM bias adjustment=FALSE but estimate h) ####
updated_input <- save_initial_input(base_case=FALSE,
                                    input_list=base_case_input,
                                    case_name="C4",
                                    om_bias_cor=TRUE,
...
#### Case 5 (EM bias adjustment=TRUE, AMAK & BAM uses mean-unbiased values) ####
updated_input <- save_initial_input(base_case=FALSE,
                                    input_list=base_case_input,
                                    case_name="C5",
                                    om_bias_cor=TRUE,
                                    ...
                                    em_bias_cor=TRUE)
run_om(input_list=updated_input , show_iter_num=F)
print(paste("AMAK h =", exp(om_input$mean_h)/(4+exp(om_input$mean_h))))
run_em(em_names=c("AMAK", "BAM", "SS"), input_list=updated_input)
